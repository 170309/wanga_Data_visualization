function btnStartSpinning(e) {
    "use strict";
    e.hasClass("btn-loading") && e.prop("disabled", !0).addClass("btn-spinning")
...
(function(e) {
...
}).apply(this, [jQuery]), function(e) {
    "use strict";
    var n = function(n) {
        var s = n.attr("data-target"), t = n.attr("data-toggle-class");
    ...
    function s(n) {
        console.log("close item"), n.children("ul.child-nav").slideUp(300, function() {
    ...
    e(".panel").on("click", ".toggle-panel.panel-expand", function() {
        ...
        var n = e(this).closest(".panel"), s = n.parent();
    ...
    var t = e("html"), i = e("#left-sidebar-collapsed"), o = e("#content-header-fixed"), l = e("#left-sidebar-fixed"), a = e("#header-fixed");
